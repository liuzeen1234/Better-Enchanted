...
| 快速装填 (Quick Charge) | 减少无限附魔的冷却时间，每级减少20%冷却时间（Lv I=8s, Lv II=6s, Lv III=4s, Lv IV=2s, Lv V=0s） | ⭐⭐ |
...
15. **快速装填 (Quick Charge)** — 减少无限附魔的冷却时间  
    ...
    - 每级减少20%冷却时间（基础10s × (1 - 0.2 × level)）
    - Lv I = 8s, Lv II = 6s, Lv III = 4s, Lv IV = 2s, Lv V = 0s（无冷却）
